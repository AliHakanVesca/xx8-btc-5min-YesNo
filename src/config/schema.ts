...
export const envSchema = z.object({
  ...
  PAIR_SWEEP_STRICT_CAP: numberString.default(1.005),
  XUAN_PAIR_SWEEP_SOFT_CAP: numberString.default(1.02),
  XUAN_PAIR_SWEEP_HARD_CAP: numberString.default(1.035),
  ENABLE_XUAN_HARD_PAIR_SWEEP: booleanString.default(false),
  ...
  ALLOW_XUAN_COVERED_SEED: booleanString.default(false),
