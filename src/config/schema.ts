...
export const envSchema = z.object({
  ...
  COMPLETION_TARGET_MAX_DELAY_SEC: numberString.default(60),
  COMPLETION_URGENCY_STRICT_SEC: numberString.default(15),
  COMPLETION_URGENCY_PATIENT_SEC: numberString.default(45),
  COMPLETION_URGENCY_FORCE_SEC: numberString.default(90),
  COMPLETION_URGENCY_MAX_PRICE_PREMIUM: numberString.default(0.015),
