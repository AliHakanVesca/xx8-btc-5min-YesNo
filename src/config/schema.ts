...
export const envSchema = z.object({
  ...
  COMBINED_CAP_BASE: numberString.default(0.977),
  COMBINED_CAP_SAFE: numberString.default(0.97),
  COMBINED_CAP_AGGRESSIVE: numberString.default(0.982),
  ENTRY_TAKER_BUY_ENABLED: booleanString.default(true),
  MAKER_QUOTING_ENABLED: booleanString.default(false),
  ENTRY_TAKER_PAIR_CAP: numberString.default(1.02),
  COMPLETION_CAP: numberString.default(0.982),
  HARD_PAIR_TAKER_CAP: numberString.default(0.964),
  MIN_EDGE_PER_SHARE: numberString.default(0.004),
  LOT_LADDER: numberList.default([30, 60, 90, 120, 145]),
  LIVE_SMALL_LOTS: numberList.default([30, 60]),
  DEFAULT_LOT: numberString.default(60),
