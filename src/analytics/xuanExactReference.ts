...
const exact1776248100Reference: CanonicalReferenceExtract = {
  slug: "btc-updown-5m-1776248100",
  startTs: 1776248100,
  endTs: 1776248400,
  orderedClipSequence: [
    exactEvent({
    ...
    exactEvent({
      ...
      qtyBucket: "31_plus",
      baseLot: 61.37359,
      internalLabel: "EXPENSIVE_FIRST_SEED",
    }),
    exactEvent({
      sequenceIndex: 11,
      clipIndex: 12,
      ...
      tOffsetSec: 68,
      outcome: "UP",
      price: 0.2461664025356577,
      qty: 59.67519,
      qtyBucket: "31_plus",
      baseLot: 61.37359,
      internalLabel: "CHEAP_LATE_COMPLETION",
    }),
  ],
  cycleCount: 6,
  mergeCount: 0,
  ...
  buySequence: ["UP", "DOWN", "DOWN", "UP", "UP", "DOWN", "DOWN", "UP", "UP", "DOWN", "DOWN", "UP"],
  alternatingTransitionCount: 6,
  authority: {
    tradeTape: "json",
    lifecycle: "inferred",
    wallet: "0xcfb103c37c0234f524c632d964ed31f117b5f694",
...
const exactReferences = [exact1776928800Reference, exact1776253500Reference, exact1776248100Reference];
...
function resolveCompletionPriorFromReference(
  ...
  return {
    ...
    internalLabel: event.internalLabel,
    scope,
  };
}
...
export { exact1776928800Reference, exact1776253500Reference, exact1776248100Reference };
